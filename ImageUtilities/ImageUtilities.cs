...
namespace ImageUtilities
{
    ...
    /// </summary>
    public static Bitmap Colorm2bitmap(Color[,] im)
    {
    ...
    /// </summary>
    public static Color[,] Bitmap2colorm(Bitmap im_bitmap)
    {
    ...
    /// </summary>
    /// <param name="path">File path relative to the executable</param>
    public static void SaveImage(Color[,] im, string path_out)
    {
      Bitmap outputImage = Colorm2bitmap(im);
      outputImage.Save(path_out);
    }
